...
function Student() {
  ...
  return (
    <div>
      <div>
        <div onClick={() => handleCircleClick('red')} className={selected === 'red' ? 'selected' : ''}>Red</div>
        <div onClick={() => handleCircleClick('yellow')} className={selected === 'yellow' ? 'selected' : ''}>Yellow</div>
        <div onClick={() => handleCircleClick('green')} className={selected === 'green' ? 'selected' : ''}>Green</div>
      </div>
